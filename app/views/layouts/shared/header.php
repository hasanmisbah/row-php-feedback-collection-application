        ...
        <div class='hidden lg:flex lg:flex-1 lg:justify-end'>
            <?php if(isAuthenticated()) :?>
                <span class='text-sm font-semibold leading-6 text-gray-900'>
                    <?php echo authenticatedUser()['name']; ?>
                </span>
            <?php else: ?>
                <a class='text-sm font-semibold leading-6 text-gray-900' href="/login">login</a>
            <?php endif; ?>
        </div>
    </nav>
        ...
        <div
            ...
            <div class='mt-6 flow-root'>
                <div class='-my-6 divide-y divide-gray-500/10'>
                    <div class='py-6'>
                        <span
                            class='-mx-3 block rounded-lg px-3 py-2.5 text-base font-semibold leading-7 text-gray-900 hover:bg-gray-50'>John Doe</span>
                    </div>
                </div>
            </div>
        </div>
...
<main class=''>
    <div class='relative flex min-h-screen overflow-hidden bg-gray-50 py-6 sm:py-12'>
        <img src='<?php asset('img/beams.jpg') ?>' alt=''
             class='absolute top-1/2 left-1/2 max-w-none -translate-x-1/2 -translate-y-1/2' width='1308'/>
        <div class='absolute inset-0 bg-[url(<?php asset('img/grid.svg') ?>)] bg-center [mask-image:linear-gradient(180deg,white,rgba(255,255,255,0))]'></div>
